...
//     val position: Double
//         get() = motors.fold(0.0) { acc, motor -> acc + motor.encoder.position } / motors.size * Constants.WHEEL_CIRCUMFERENCE_INCHES
...
//         gyroRate = (pigeon?.yaw ?: 0 - lastYaw) / Constants.COMMAND_SCHEDULER_PERIOD_SECONDS
